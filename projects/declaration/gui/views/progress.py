...
from declaration.gui.workers import FetchWorker
...
class ProgressView(QWidget):
    ...
    def retranslate(self):
        ...
        for key in ("progress_title", "progress_done", "progress_error"):
            from declaration.i18n import _STRINGS
    ...
    def start(self, client, declaration_id: str, year: int):
        self._log.clear()
        self._bar.setRange(0, 0)
        self._open_btn.setVisible(False)
        self._new_btn.setVisible(False)
        ...
        self._worker = FetchWorker(client, declaration_id, year)
    ...
    def _on_open(self):
        ...
        get_adapter().open_report(self._filename)

    def _on_new(self):
        self._window.navigate(self._window.year_view)
