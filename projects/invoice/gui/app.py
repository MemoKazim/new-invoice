...
from invoice import __version__, __copyright__
from invoice.i18n import t, set_language
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setFixedSize(540, 520)   # room for menu bar + status bar
    ...
    def _build_views(self):
        from invoice.gui.views.login import LoginView
        from invoice.gui.views.asan_confirm import AsanConfirmView
        from invoice.gui.views.certificate import CertificateView
        from invoice.gui.views.params import ParamsView
        from invoice.gui.views.progress import ProgressView
        ...
        for view in (self.login_view, self.asan_view, self.cert_view,
                     self.params_view, self.progress_view):
...
_BASE = """
    ...
    QDateEdit  { border-radius: 4px; padding: 5px 8px; }
...
_LIGHT = _BASE + """
    ...
    QDateEdit    { background: white;   color: #1a1a1a; border: 1px solid #c0c0c0; }
...
_DARK = _BASE + """
    ...
    QDateEdit    { background: #3c3c3c; color: #e8e8e8; border: 1px solid #555555; }
    QLabel       { color: #e8e8e8; }
    ...
    QCalendarWidget QWidget      { background: #2d2d2d; color: #e8e8e8; }
    QCalendarWidget QToolButton  { background: #3c3c3c; color: #e8e8e8; border: none; }
    QCalendarWidget QSpinBox     { background: #3c3c3c; color: #e8e8e8; }
